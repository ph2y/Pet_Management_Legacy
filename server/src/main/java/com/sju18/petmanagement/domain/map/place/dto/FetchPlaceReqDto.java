...
public class FetchPlaceReqDto {
    ...
    private Long id;
    @DecimalMax(value = "90.0", message = "valid.place.currentLat.max")
    @DecimalMin(value = "-90.0", message = "valid.place.currentLat.min")
    private BigDecimal currentLat;
    @DecimalMax(value = "180.0", message = "valid.place.currentLong.max")
    @DecimalMin(value = "-180.0", message = "valid.place.currentLong.min")
